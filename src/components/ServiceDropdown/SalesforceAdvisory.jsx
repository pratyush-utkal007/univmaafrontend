  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0B0B1A] text-white font-sans">
        ...
        >
          ...
          <div className="text-center md:text-left">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              className="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 rounded-lg font-semibold inline-block"
            >
              Contact Us →
            </motion.a>
          </div>
        ...
        {/* CTA Section */}
        <div className="bg-slate-950 text-white px-4 sm:px-20 py-16">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ amount: 0.3, once: false }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-r from-purple-800 to-teal-950 rounded-lg text-center p-6 sm:p-10 max-w-5xl mx-auto my-16"
          >
